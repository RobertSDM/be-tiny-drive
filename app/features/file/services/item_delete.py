...
from app.utils.utils import make_file_bucket_path, make_file_preview_bucket_path
...
class FileDeleteService:
    ...
    def delete_items(self, db: Session, ownerid: str, items: list[str]) -> list[str]:
        deleted = []
        ...
        for id in items:
            ...
            if item.type == FileType.FOLDER:
                ...
                self.delete_items(db, ownerid, children)
