...
-   **File Optimization:** When generating the preview, the files are converted to JPG and resized.
-   **File Preview:**
...
-   **File Deletetion:** To ensure reduce metadata and filedata atomicity, the files to be deleted are first stored in a trash bucket and then removed.
