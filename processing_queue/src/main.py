...
from processing_queue.src.constants import DEFAULT_WORKERS_NUMBER
from processing_queue.src.lib.rabbitmq import consumer
from processing_queue.src.workers import preview_worker
...
def main():
    ...
    print(f"Running {DEFAULT_WORKERS_NUMBER} workers")
